...
require (
	...
	github.com/konstructio/kubefirst-api v0.136.0
...
require (
	...
	sigs.k8s.io/aws-iam-authenticator v0.6.28 // indirect
...
// Gitops-engine specific pinning
replace (
...
// Kustomize v4 build specific pinning
replace (
	// Kustomize v4 specific dependencies
