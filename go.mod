...
require (
	...
	github.com/konstructio/kubefirst-api v0.117.0
...
replace (
	// A newer version of ArgoCD import does not work with the current pinned
	// versions of k8s.io packages. The latest version that also works with
	// gitops-engine is ArgoCD v2.9.3:
	// https://github.com/argoproj/argo-cd/blob/v2.9.3/go.mod#L301-L326
	github.com/argoproj/argo-cd/v2 => github.com/argoproj/argo-cd/v2 v2.9.3

	// Needs to be updated once kubefirst-api is updated. See:
	// https://github.com/konstructio/kubefirst-api/blob/v0.117.0/go.mod#L302
	github.com/argoproj/gitops-engine => github.com/argoproj/gitops-engine v0.7.1-0.20221208230615-917f5a0f16d5

	// Needs to be updated once kubefirst-api is updated. See:
	// https://github.com/konstructio/kubefirst-api/blob/v0.117.0/go.mod#L29
	github.com/civo/civogo => github.com/civo/civogo v0.3.53

	// Needs to be updated once kubefirst-api is updated. See:
	// https://github.com/konstructio/kubefirst-api/blob/v0.117.0/go.mod#L254
	github.com/xanzy/go-gitlab => github.com/xanzy/go-gitlab v0.81.0

	// These need to be updated once kubefirst-api imports a newer version of argoproj/gitops-engine.
	// Then these can match the upstream pinning in the gitops-engine go.mod pinning.
	// See: https://github.com/konstructio/kubefirst-api/blob/v0.117.0/go.mod#L321-L345
	...
	// These also need to be updated when kubefirst-api is updated.
	// See: https://github.com/konstructio/kubefirst-api/blob/v0.117.0/go.mod#L80-L85
