...
`kubefirst` is the name of our cli that installs the kubefirst platform. It can be downloaded [here](https://github.com/kubefirst/kubefirst/releases) and its source code is [here](https://github.com/kubefirst/kubefirst).
