...
To install the Kubefirst Platform see [install](../kubefirst/install.md)
...
We've tried our best to surface available customizations and patterns of the kubefirst platform here on our docs site. We've also made [links available](../kubefirst/credit.md) to all of our open source tools' own sources of documentation as well.
