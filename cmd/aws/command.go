...
func Create() *cobra.Command {
	...
	createCmd.Flags().StringVar(&gitopsTemplateBranchFlag, "gitops-template-branch", "aws-domain-refactor-6", "the branch to clone for the gitops-template repository")
