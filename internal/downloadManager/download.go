...
func DownloadTools(config *configs.Config) error {
	...
	// currently argocd initialization values is generated by kubefirst ssh
	// todo helm install argocd --create-namespace --wait --values ~/.kubefirst/argocd-initialization-values.yaml argo/argo-cd
	if errHelm != nil {
